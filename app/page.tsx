  ...
  return (
    <div className="min-h-screen">
        ...
        <div className="max-w-7xl mx-auto px-4 lg:px-8">
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <div className="space-y-8">
              <div>
                <h2 className={`${greatVibes.className} text-5xl font-light text-gray-900 mb-6`}>About Rose Jewels</h2>
      ...
      <section className="py-32 bg-white mt-32">
        <div className="max-w-7xl mx-auto px-4 lg:px-8">
          <div className="text-center mb-16">
            <h2 className={`${greatVibes.className} text-5xl font-light text-gray-900 mb-4`}>Shop by Category</h2>
      ...
      <section className="py-20 bg-gray-50">
        <div className="max-w-7xl mx-auto px-4 lg:px-8">
          <div className="text-center mb-16">
            <h2 className={`${greatVibes.className} text-5xl font-light text-gray-900 mb-4`}>Featured Products</h2>
            <p className="text-gray-600 max-w-2xl mx-auto text-lg">
          ...
          <div className="text-center mt-12">
            <Link href="/products">
              <Button
                variant="outline"
                size="lg"
                className="border-rose-600 text-rose-600 hover:bg-rose-600 hover:text-white bg-transparent px-8 py-3 text-lg"
              >
